...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        // Main method responsible for checking password strength throughout the whole password proposal
        PasswordStrengthWholePassword passwordStrengthWholePassword = new PasswordStrengthWholePassword();

        passwordStrengthWholePassword.checksPasswordStrengthThroughTheWholePassword();
