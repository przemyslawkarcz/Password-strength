...
import static Password_Strength_Whole_Password.PasswordStrengthWholePassword.checksPasswordStrengthThroughTheWholePassword;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        checksPasswordStrengthThroughTheWholePassword();
